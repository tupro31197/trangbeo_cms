                                    ...
                                    @foreach ($categories as $index => $category)
                                        <tr data-widget="expandable-table" aria-expanded="false">
                                            ...
                                            <td style="vertical-align: middle ">
                                                <a href=""
                                                    class="btn btn-info btn-circle btn-sm addProductByCate"
                                            ...
                                            <div class="modal fade" id="delete{{ $category['id'] }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">Tên danh mục: {{ $category['name'] }}</div>
                    ...
                    <form action="" method="post" id="formUpdatecategory" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 ">
                                    <div class="form-group">
                                        <label for="inputTitle">Tên danh mục sản phẩm</label>
                                        <input type="text" class="form-control" id="inputTitle" required name="name"
                                ...
                                <div class="col-12 ">
                                    <div class="form-group">
                                        ...
                                        <select name="parent" class="form-control  d-block" id="parent">
                ...
                success: function(res) {
                    ...
                    $("#parent option").each(function() {
                        if (category.parent != 0) {
                            if ($(this).val() == category.parent) $(this).attr('selected', true);
                        }
                    });
